...
import { ProductUpdatedUseCase } from '..';
import { ProductCategoryEnum, TypeNameEnum } from '@domain';

describe('ProductUpdatedUseCase', () => {
  let mockProductService: IProductDomainService;
  let productRegisteredUseCase: ProductUpdatedUseCase;
  ...
  beforeEach(() => {
    ...
    productRegisteredUseCase = new ProductUpdatedUseCase(mockProductService);
  });
